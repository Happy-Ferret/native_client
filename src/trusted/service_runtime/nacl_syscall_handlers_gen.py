...
SYSCALL_LIST = [
    ...
    #extended for Lind
    ('NACL_sys_select', 'NaClSysSelect', ['uint32_t nfds', 'fd_set *readfds', 'fd_set *writefds', 'fd_set *exceptfds', 'struct timeval *timeout']),
    ...
    ('NACL_sys_socketpair', 'NaClSysSocketPair', ['int domain', 'int type', 'int protocol', 'int* sv']),
    ('NACL_sys_send', 'NaClSysSend', ['int sockfd', 'const void *buf', 'size_t len', 'int flags']),
    ('NACL_sys_sendto', 'NaClSysSendTo', ['int sockfd', 'const void *buf', 'size_t len', 'int flags', 'const struct sockaddr *dest_addr', 'socklen_t addrlen']),
    ('NACL_sys_sendmsg', 'NaClSysSendMsg', ['int sockfd', 'const struct msghdr *msg', 'int flags']),
    ('NACL_sys_recv', 'NaClSysRecv', ['int sockfd', 'void *buf', 'size_t len', 'int flags']),
    ('NACL_sys_recvfrom', 'NaClSysRecvFrom', ['int sockfd', 'void *buf', 'size_t len', 'int flags', 'struct sockaddr *src_addr', 'socklen_t *addrlen']),
    ('NACL_sys_recvmsg', 'NaClSysRecvMsg', ['int sockfd', 'struct msghdr *msg', 'int flags']),
    ...
    ('NACL_sys_setsockopt', 'NaClSysGetSockOpt', ['int sockfd', 'int level', 'int optname', 'const void *optval', 'socklen_t optlen']),
    ('NACL_sys_fcntl', 'NaClSysFcntl', ['int fd', 'int cmd', 'int opt']),
    #('NACL_sys_getpid', 'NaClSys', []),
    #('NACL_sys_getuid', 'NaClSys', []),
    #('NACL_sys_getgid', 'NaClSys', []),
    #('NACL_sys_geteuid', 'NaClSys', []),
    #('NACL_sys_getegid', 'NaClSys', []),
    #('NACL_sys_getrlimit', 'NaClSys', []),
    #('NACL_sys_setrlimit', 'NaClSys', []),
    ]
